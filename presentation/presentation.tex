...
\begin{frame}{Présentation du jeu}
    \begin{block}{Caractéristiques}
        \begin{itemize}
            ...
            \end{itemize}
            \item[\bullet] Niveau : pas de choix --> génération aléatoire
...
\begin{frame}{Organisation du travail}
    \begin{block}{Notre organisation}
        \begin{itemize}
            ...
            \item[\bullet] Un grand objectif global par pé  riode
...
\begin{frame}{Conclusion}
    \begin{block}{Résultats}
        \begin{itemize}
            ...
            \begin{itemize}
                \item[→] Moteur physique fonctionnel
                \item[→] Génération procédurale
                \item[→] Mécaniques du personnage
            \end{itemize}
        \end{itemize}
    \end{block}
