...
\begin{itemize}
  ...
  \item \textbf{staticFriction}: %TODO: Différence entre staticFriction et dynamicFriction?
...
Les blocs sont stockés et gérés par un objet BlockManager.

Cet objet permet de stocker les blocs du monde, en associant une position x et y à un nom de bloc.
...
% TODO: Mettres les logos des outils utilisés ? Au moins celui de gf
