...
Nore organisation se basait sur un processus itératif.
Nous avons réparti notre organisation en "periodes" correspondant au temps entre deux rendez-vous avec notre tuteur.
Après chaque réunion, nous discutions d'un objectif général à atteindre pour le prochain rendez vous.
A partir de cette discussions, nous convenions d'un ensemble de tâches à réaliser pour atteindre cet objectif, qui étaient ajoutées sur le tabeau Trello.
Chaque membre du groupe était libre de choisir les tâches qu'il souhaitait et se sentait capable de réaliser.\par

Cette organisation était très dynamique, et a permi aux membres du groupe de de travailler sur différentes parties du projet à leur guise.

\subsection{Les outils utilisés}
% TODO: Mettre les logos des outils utilisés ? Au moins celui de gf. À moins qu'on le mettre uniquement dans la présentation?
...
Nous avions de multiples idées lors du début du projet qui n'ont pas pu être implémentées soit à cause de leur difficulté, soit par manque de temps, soit parce qu'elles ne convenaient plus  à la trajectoire qu'avait pris le projet.
...
\begin{itemize}
  ...
  \item \emph{Clés}: Les clés auraient été associées aux portes, et auraient permi de les ouvrir pour progresser ou augmenter le score.
        L'idée a été abandonnée car trop complexe à implémenter.
  \item \emph{Téléporteurs} : Les téléporteurs auraient permi de parcourir de grande distances dans le niveau de manière instantanée
        L'idée a été abandonnée car trop complexe pour la génération procédurale
  \item \emph{Des bonus} : Les bonus auraient été des objets récoltables permettant de changer des mécanoiques de gameplay.
        L'idée des bonue a été abandonnée car ne convenant par au gameplay que nous commencions à créer
